...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		log.info("Buscando Lançamentos por Id de um Funcionario: {}, página: {}", funcionarioId, pag);
	...
	public ResponseEntity<Response<LancamentoDto>> atualizar(@PathVariable("id") Long id,
		...
		Response<LancamentoDto> response = new Response<LancamentoDto>();
		validarFuncionario(lancamentoDto, result);
		lancamentoDto.setId(Optional.of(id.toString()));
		Lancamento lancamento = this.converterDtoParaLancamento(lancamentoDto, result);
	...
	private LancamentoDto converterLancamentoDto(Lancamento lancamento) {
		...
		lancamentoDto.setId(Optional.of(lancamento.getId().toString()));
	...
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result)
		...
		if (lancamentoDto.getId().isPresent()) {
			Optional<Lancamento> lanc = this.lancamentoService.buscarPorId(Long.valueOf(lancamentoDto.getId().get()));
			if (lanc.isPresent()) {
				lancamento = lanc.get();
			} else {
